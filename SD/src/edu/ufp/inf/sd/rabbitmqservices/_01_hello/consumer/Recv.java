package edu.ufp.inf.sd.rabbitmqservices._01_hello.consumer;
 ...
 *
 * <p>
 * 2. Run consumer ReceiveLogs that keeps running, waiting for messages from publisher EmitLog (Use Ctrl-C to stop):
 * $ ./runconsumer
 *
 * <p>
 * 3. Run publisher EmitLog several times from terminal (will send mesg "hello world"):
 * $ ./runproducer
 *
 * <p>
...
public class Recv {
    ...
    /**
     * Run consumer ReceiveLogs that keeps running, waiting for messages from publisher EmitLog (Use Ctrl-C to stop):
     * $ ./runconsumer
     *
     * @param args
     */
    public static void main(String[] args) {
        try {
            ...
            //channel.queueDeclare(EmitLog.QUEUE_NAME, true, false, false, null);
